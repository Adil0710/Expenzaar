        ...
        <tr style="width: 100%">
          <td>
            <img
              alt="Plaid"
              height="88"
              src="https://expenzaar.vercel.app/public/expenzaar-dark.png"
              style="
                display: block;
                outline: none;
                border: none;
            ...
            <h1
              ...
              "
            >
              Hello ${name}, Here's your 6-digit OTP.
            </h1>
            <table
              align="center"
              width="100%"
            ...
            <p
              ...
              "
            >
              Please use the above OTP to reset your password,
              <span style="font-weight: bold; color: #232323"
                >This code will expire in 10 minutes.</span
              >
            </p>
            <p
              style="
